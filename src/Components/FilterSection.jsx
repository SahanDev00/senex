...
const FilterSection = ({ subCategory, onClose }) => {
  return (
    <div className="w-[250px] border-red-600 border mt-4 bg-white relative">
      <div className="w-full h-[50px] border bg-red-600 border-white flex justify-between items-center px-4">
        <h1 className="text-white uppercase font-semibold text-lg">Filters</h1>
      ...
      <div className="my-4 ml-3">
        ...
        <ul>
          <li className="mb-2 uppercase text-sm cursor-pointer">
            <label>
              <input type="checkbox" className="mr-2" /> Filter 1
            </label>
          </li>
          <li className="mb-2 uppercase text-sm cursor-pointer">
            <label>
              <input type="checkbox" className="mr-2" /> Filter 2
            </label>
          </li>
          <li className="mb-2 uppercase text-sm cursor-pointer">
            <label>
              <input type="checkbox" className="mr-2" /> Filter 3
            </label>
          </li>
