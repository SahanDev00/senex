...
const Cards = () => {
  return (
    /* Special Offers */
    <div className=' w-[90%] sm:w-[90%] mx-auto md:mx-0 md:w-[97%] lg:w-[95%] lxl:w-[87%] mxl:w-[95%] 2xl:w-[90%] grid-cols-1 grid lg:grid-cols-3 items-center mt-12 sm:mt-16 lg:mt-12'>
        ...
        {/* New Arrivals */}
        <div className='w-[330px] xs:w-[370px] sm:w-[550px] ssm:w-[480px] md:w-[650px] lg:w-[210px] xl:w-[250px] 2xl:w-[440px] mx-auto'>
