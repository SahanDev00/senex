    ...
    <div className=' w-full h-[300px] flex gap-4 items-center mt-7'>
        <div className=' w-[455px] rounded-2xl border-white'>
            <div className='relative w-full rounded-lg h-[250px] flex items-cente border-white bg-white'>
                ...
                <button className='absolute w-full h-full bg-black/50 border-white border-2 rounded-lg font-bold text-white text-3xl hover:text-[32px] duration-300 ease-in-out hover:shadow-lg'>SPECIAL OFFERS</button>
            </div>
        </div>
        ...
        <div className='w-[385px] '>
            <div className='relative w-full rounded-lg h-[250px] flex items-center bg-white '>
                ...
                <button className='absolute w-full h-full bg-black/50 rounded-lg font-bold text-white border-2 text-3xl hover:text-[32px] duration-300 ease-in-out hover:shadow-lg'>NEW ARRIVALS</button>
            </div>
        </div>
        ...
        <div className=' w-[455px] rounded-2xl '>
            <div className='relative w-full rounded-lg h-[250px] flex items-center bg-white'>
                ...
                <button className='absolute w-full h-full bg-black/50 rounded-lg font-bold text-white border-2 text-3xl hover:text-[32px] duration-300 ease-in-out hover:shadow-lg'>FEATURED</button>
            </div>
        </div>
    </div>
  )
