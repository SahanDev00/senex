...
const BestSelling = () => {
  ...
  return (
    <div className='w-[84%] h-[50vh] flex mx-auto mt-14'>
      <div className='w-full h-full'>
        <h1 className='font-semibold text-2xl mb-2 text-red-600'>BEST SELLING ITEMS</h1>
        <hr />
        <div className='mt-5 w-full h-[370px] overflow-hidden'>
          ...
          {bestSellingItems.map((product, index) => (
              <div key={index} className='w-[260px] bg-white hover:scale-105 duration-300 h-[320px] rounded-xl mx-4 p-4 shadow hover:shadow-md border-2 flex-shrink-0'>
