...
const Searchbar = ({ onSearch }) => {
  ...
  return (
    <div className='w-[320px] lg:ml-6 2xl:ml-12 sm:ml-6 md:ml-14 sm:w-[600px] md:w-[700px] mx-auto justify-center lg:w-[80%] xl:w-[65%] mxl:w-[940px] 2xl:w-[89%]  mt-4 flex items-center h-[50px]'>
