...
const Searchbar = ({ onSearch }) => {
  ...
  return (
    <div className='w-[330px] xxs:w-[370px] xs:w-[370px] lg:ml-6 mxl:ml-10 lxl:ml-6 2xl:ml-11 sm:ml-6 md:ml-14 sm:w-[600px] ssm:w-[480px] md:w-[650px] mx-auto justify-center lg:w-[710px] xl:w-[950px] mxl:w-[980px] 2xl:w-[89%]  mt-4 flex items-center mxl:h-[50px] xl:h-[40px] h-[50px]'>
